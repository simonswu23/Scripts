...
class PBStuff
  ...
  TRACEABILITIES = [:PROTEAN,:CONTRARY,:INTIMIDATE, :WONDERGUARD,:MAGICGUARD,
    ...
    :LIGHTNINGROD,:MOTORDRIVE, :VOLTABSORB,:STORMHEAL,:FLASHFIRE,:MAGMAARMOR, :ADAPTABILITY,:DEFIANT,:COMPETITIVE, 
...
###--------------------------------------PROTECTMOVE------------------------------------------------------------###
PROTECTMOVE = [:PROTECT, :DETECT,:KINGSSHIELD, :SPIKYSHIELD, :BANEFULBUNKER, :OBSTRUCT, :SHELTER, :PESTER, :PARRY]

###--------------------------------------PROTECTIGNORINGMOVE----------------------------------------------------###
PROTECTIGNORINGMOVE = [:FEINT, :HYPERSPACEHOLE,:HYPERSPACEFURY, :SHADOWFORCE, :PHANTOMFORCE, :ONEBLOW]
...
BULLETMOVE = [:ACIDSPRAY, :AURASPHERE,:BARRAGE, :BULLETSEED,
  ...
  :SLUDGEBOMB, :WEATHERBALL, :ZAPCANNON, :BEAKBLAST, :PYROBALL,:CANNONBALL,:FLASHCANNON,:DARKPULSE,:AURASPHERE,
  :DRAGONPULSE,:TERRAINPULSE,:HYDROCANNON,:WATERPULSE,:ORIGINPULSE,:DYNAMAXCANNON,:FLEURCANNON,:MUDBARRAGE]
...
RATESHARERS = [:PROTECT, :DETECT,:QUICKGUARD, :WIDEGUARD, :ENDURE,
  :KINGSSHIELD, :SPIKYSHIELD, :BANEFULBUNKER, :CRAFTYSHIELD, :OBSTRUCT, :SHELTER, :PESTER, :PARRY]

###--------------------------------------INVULEFFECTS-----------------------------------------------------------###
INVULEFFECTS = [:Protect, :Endure, :Obstruct, :KingsShield, :SpikyShield, :MatBlock, :BanefulBunker, :Parry]
...
NOCOPYMOVE = [:ASSIST,:COPYCAT, :MEFIRST, :METRONOME, :MIMIC, :MIRRORMOVE,
  ...
  :BELCH, :CHATTER, :KINGSSHIELD, :BANEFULBUNKER, :BESTOW, :COUNTER, :COVET, :DESTINYBOND, :DETECT, :PARRY,
...
EVOSTONES = [:WATERSTONE, :FIRESTONE, :THUNDERSTONE, :LEAFSTONE, :SUNSTONE, :MOONSTONE, :DAWNSTONE, :DUSKSTONE, :SHINYSTONE, :ICESTONE]

MINTS = [:ADAMANTMINT, :LONELYMINT, :NAUGHTYMINT, :BRAVEMINT, :BOLDMINT, :IMPISHMINT, :LAXMINT, :RELAXEDMINT, :MODESTMINT, :MILDMINT, :RASHMINT,
         :QUIETMINT, :CALMMINT, :GENTLEMINT, :CAREFULMINT, :SASSYMINT, :TIMIDMINT, :HASTYMINT, :JOLLYMINT, :NAIVEMINT, :SERIOUSMINT]
...
:METRONOME => NOCOPYMOVE | ZMOVES | [:AFTERYOU, 
  ...
  :JUDGEMENTROCK, :JUDGEMENTSTEEL, :JUDGEMENTWATER, :HIDDENPOWERNOR, :HIDDENPOWERFIR, :HIDDENPOWERFIG,
...
FLINGDAMAGE=pbHashForwardizer({
  ...
  30 => [:ELECTRICTERRAIN, :ENCORE,:GLARE,
         ...
         :SPIKES,       :STEALTHROCK, :STEELSURGE,     :SPIKYSHIELD,:THUNDERWAVE,:TOXICSPIKES,:TRICKROOM],
...
POKEMONTOGIGASTONE = {
  :CHARIZARD  => [:CHARIZARDITEG],
  :VENUSAUR   => [:VENUSAURITEG],
  :BLASTOISE  => [:BLASTOISINITEG],
  :GENGAR     => [:GENGARITEG],
  :BUTTERFREE => [:BUTTERFREENITE], :MACHAMP    => [:MACHAMPITE],
  :PIKACHU    => [:PIKACHUTITE],    :MEOWTH     => [:MEOWTHITE],
  :KINGLER    => [:KINGLERITE],     :LAPRAS     => [:LAPRASITE],
  ...
  :VANILLUXE    => [:VANILLUXITE],  :FERROTHORN => [:FERROTHORNITE],
...
POKEMONTOGIGAMOVE = {
  ...
  :EEVEE      => [:CUDDLESTORM],    :SNORLAX    => [:PULVERIZE],
  :GARBODOR   => [:LANDFILL],       :MELMETAL   => [:MELTDOWN],
  :CORVIKNIGHT=> [:WINDRAGE],       :ORBEETLE   => [:ORBEETLENITE],
  :DREDNAW =>    [:STONESURGE],    :COALOSSAL  => [:VOLCALITH],
  :FLAPPLE    => [:FLAPPLETITE],    :APPLETUN   => [:HONEYPOT],
  ...
  :VANILLUXE    => [:FLASHFREEZE],  :FERROTHORN => [:OVERGROWTH],
  :BASTIODON    => [:STEELAGE]
}
...
POKEMONTOCREST = {
  ...
  :FURRET => :FURRCREST,              :GASTRODON => :GASTROCREST,
  :HYDREIGON => :HYDREICREST,         :VOLCARONA => :VOLCARONACREST,
  :TOXAPEX => :TOXAPEXCREST,          :DARKRAI => :DARKRAICREST,
  :RUNERIGUS => :RUNERIGUSCREST,      :GOODRA => :GOODRACREST,
  :CACTURNE => :CACTURNECREST,        :LUMINEON => :LUMINEONCREST,
  :VANILLUXE => :VANILLUXECREST,      :BRONZONG => :BRONZONGCREST,
  :PLUSLE => :PLUSLECREST,            :MINUN => :MINUNCREST,
  :RILLABOOM => :RILLACREST,          :CINDERACE => :CINDERCREST,
  :INTELEON =>  :INTELCREST,          :ALCREMIE =>  :ALCREMIECREST,
  :SANDACONDA => :SANDACONDACREST,    :CORVIKNIGHT=> :CORVICREST,
  :COPPERAJAH => :COPPERACREST,       :TOXTRICITY=>  :TOXTRICREST,
  :GOREBYSS   => :GORECREST,          :HUNTAIL =>    :HUNTACREST,
  :SUNFLORA   => :SUNFLORACREST,      :WIGGLYTUFF => :WIGGLYCREST,
  :AGGRON     => :BASTCREST2,         :BRAVIARY =>   :BRAVIARYCREST,
  :KLINKLANG  => :KLINKLANGCREST,     :EMBOAR =>     :EMBOARCREST,
  :ELECTIVIRE => :ELECTICREST,        :CROBAT  =>    :CROCREST, 
  :JELLICENT  => :JELLICREST,         :SPINDA  =>    :SPINCREST,
  :TROPIUS    => :TROPCREST, 
}
...
class PBFields
  #PBStuff for field effects.
    ...
    :FAIRYWIND, :GUST, :SEABREEZE]

  WINDRIDERMOVES = [:SEABREEZE, :SPRINGBREEZE, :AEROBLAST, :AIRCUTTER, :BLEAKWINDSTORM, :BLIZZARD, :FAIRYWIND, :GUST, :HEATWAVE, :HURRICANE,
    :ICYWIND, :PETALBLIZZARD, :SANDSEARSTORM, :ETHEREALTEMPEST, :SANDSTORM, :SPRINGTIDESTORM, :TAILWIND, :TWISTER, :WHIRLWIND, :WILDBOLTSTORM,
    :SILVERWIND, :OMINOUSWIND, :RAZORWIND]
    ...
    :LAVAPLUME, :FIREPLEDGE, :MINDBLOWN, :INCINERATE, :INFERNOOVERDRIVE, :CENTIFERNO]
