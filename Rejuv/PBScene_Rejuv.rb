module PBScene
  ...
  # Text colors
  MESSAGEBASE        = Color.new(80,80,88)
  MESSAGESHADOW      = Color.new(160,160,168)
  MENUBASE           = MESSAGEBASE
  MENUSHADOW         = MESSAGESHADOW
  BOXBASE        = Color.new(238,238,238)
  BOXSHADOW      = Color.new(60,60,60)
  PPBASE         = MESSAGEBASE        # More than 1/2 of total PP
  PPSHADOW       = MESSAGESHADOW
  PPBASEYELLOW   = Color.new(248,192,0)    # 1/2 of total PP or less
  PPSHADOWYELLOW = Color.new(144,104,0)
  PPBASEORANGE   = Color.new(248,136,32)   # 1/4 of total PP or less
  PPSHADOWORANGE = Color.new(144,72,24)
  PPBASERED      = Color.new(248,72,72)    # Zero PP
  PPSHADOWRED    = Color.new(136,48,48)

  # HP bar colors
  HPGREEN        = Color.new(24,192,32)
  HPGREENDARK    = Color.new(0,144,0)
  HPYELLOW       = Color.new(248,176,0)
  HPYELLOWDARK   = Color.new(176,104,8)
  HPRED          = Color.new(248,88,40)
  HPREDDARK      = Color.new(168,48,56)
