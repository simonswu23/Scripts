...
:FLURRY => {
	...
	:target => :SingleNonUser,
	:magiccoat => true,
	:desc => "The user sends a flurry of ice at the target to inflict frostbite."
},
...
:SHIELDBASH => {
	...
	:contact => true,
	:kingrock => true,
	:desc => "The user attacks by slamming its metal body into the target. The higher the user's Defense, the more damage it can inflict."
},
...
:SLEIGHRIDE => {
	...
	:contact => true,
	:kingrock => true,
	:desc => "Gliding across the ice, the user attacks the target. This move always goes first during hail."
...
:RABBITESCAPE => {
	...
	:priority => 1,
	:kingrock => true,
	:desc => "The user engulfs the targets in a swarm of rabbits, allowing them to make a quick escape."
},
...
:CHILLINGWATER => {
	...
	:kingrock => true,
	:defrost => true,
	:desc => "The user shoots cold water at its target. It may also leave the target with a frostbite."
},
...
:DARKDELIRIUM => {
	...
	:effect => 100,
	:target => :SingleNonUser,
	:desc => "The user attacks the target's mind with twisted darkness, confusing them."
},
